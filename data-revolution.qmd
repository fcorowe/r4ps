...
The digital revolution ushered in the 1990s has unleashed a data revolution. Technological advances in computational power, storage and digital network platforms have enabled the emergence of "Big Data" or "digital footprint data". These technological developments have enabled the production, processing, analysis and storage of large volumes of digital data. Analysing the period between 1986 and 2007, @hilbert2011 estimated that the world has already passed the point at which more data were being collected than could be physically stored. They estimated that the global general-purpose computing capacity grew at an annual rate of 58 percent during 1986-2007, exceeding that of global storage capacity (23 percent). We can now digitally captured and generated data that previously could not easily be recorded and stored.
...
Digital footprint data offers unique opportunities for the analysis of human population patterns. As @rowe2021b argues, digital footprint data offer three key promises in relation to traditional data sources, such as surveys and censuses. They provide greater spatio-temporal granularity, wider coverage and timeliness.

Digital footprint data offer higher geographic and temporal granularity. Digital technology, such as mobile phone enables capturing a continuous steams of time-stamped location data with high level of precision. Using this information, we now have the ability to understand human populations use and are influenced by the geographical space in a temporally dynamic way.

Second, digital footprint data provide extensive coverage. Contrasting to traditional random sampling, digital footprint data promise information to understand the human dynamics of entire population systems or geographical areas through data generated via social media platforms, earth observation technology or electronic smartcard ticketing systems.

Third, digital footprint data is generated in real-time. Unlike traditional systems of data collection and release, digital footprint data can be streamed continuously real- or near real-time. Such information has been key to monitor and response to the COVID-19 pandemic [@green2021], natural disasters [@rowe2022c] and conflicts [@rowe2022a].
