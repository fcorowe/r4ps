...
```{r}
df_LSOA <- df_LSOA[, c("LSOA11NM", "White", "MixedMulti", "Asian", "BlackAfricanCaribbean", "Ethnic_Other", "BAME", "BirthUK", "BirthNotUK", "OwnedOutright", "OwnedMortgage", "SocialRent", "PrivateRent", "Hh_MedianIncome", "MidYrPop0to15", "MidYrPop16to29", "MidYrPop30to44", "MidYrPop45to64", "MidYrPop65")]
```

------------------------------------------------------------------------

1.  (formative feedback) Choose a variable from the list of selected demographic variables (different from EthnicBlackAfricanCaribbeanBlackBritish). Create a histogram representing the value of your variable of choice on the *x*-axis, and the number of LSOAs with a certain value of your variable of choice on the *y*-axis. Based on your histogram, can you comment on how your variable of choice is distributed? Are these demographic patterns to be expected?
2.  (formative feedback) Create a map that helps us visualise the spatial distribution of your variable of choice across all of London's LSOAs. Can you comment on the spatial patterns that you observe? Are these patterns expected for your variable of choice?
