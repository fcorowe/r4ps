...
**Assignment 2 (50%)** refer to the set of questions at the end of Chapters @sec-chp6, @sec-chp7, @sec-chp8, @sec-chp9 and @sec-chp11. You are required to use your responses to build your computational essay. Each chapter provides more specific guidance of the tasks and discussion that you are required to consider in your assignment.
